...
namespace CFA_Dot_Net.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(ILogger<EmployeesController> logger, IToastNotification toastNotification, EmployeeDbContext context)
        {
            _context = context;
            _logger = logger;
        ...
        public async Task<IActionResult> Edit(int id, [Bind("id,name,Designation")] Employee employee)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    _toastNotification.AddWarningToastMessage("Employee Details updated successfully");
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            await _context.SaveChangesAsync();
            _toastNotification.AddErrorToastMessage("Employee Details deleted successfully");
            return RedirectToAction(nameof(Index));
        }
